-- ============================================================
-- Updates sp_list_all_pdfs to include uploader name fields
-- (uploader_username, uploader_first_name, uploader_last_name)
-- via a LEFT JOIN on dbo.users.
--
-- Run via sqlcmd:
--   sqlcmd -S 10.0.160.80 -U sa -P sa@123 -i scripts\fix_sp_list_all_pdfs_with_uploader.sql
-- ============================================================
...
BEGIN
    ...
    LEFT  JOIN dbo.users          uploader ON uploader.id = d.uploaded_by
...
PRINT 'fix_sp_list_all_pdfs_with_uploader completed — uploader name fields added.';
GO
